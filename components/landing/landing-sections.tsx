...
import { PublicPlan, TRIAL_DAYS } from "@/lib/pricing"
...
export function HeroSection({ personal }: { personal: PublicPlan }) {
	return (
		<section className="relative mb-20 flex flex-col items-center justify-between gap-12 md:flex-row">
			...
			<div className="flex-1 space-y-6 text-left">
				...
				<p className="text-secondary text-base leading-relaxed sm:text-lg">
					Describe what you ate in your own words. Confirm the estimation, and build a beautiful,
					personal archive of your daily eating patterns.
				</p>
				...
				<p className="text-muted text-xs">
					{personal.priceLabel} {personal.periodLabel} after your {TRIAL_DAYS}-day trial. Card saved
					when the trial starts — cancel any time before it ends.
				</p>
			</div>
	...
	return (
		<footer className="border-subtle text-muted flex flex-col gap-4 border-t pt-10 text-center text-xs">
			...
			<div className="text-secondary mx-auto flex max-w-xl items-center justify-center gap-2 leading-relaxed">
				...
				<span>
					Nutrition values are estimates. Portions, recipes, brands, and cooking methods can change
					the result. Review each meal before saving.
				</span>
			</div>
